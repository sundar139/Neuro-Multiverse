...
- **Raw validation status:** Completed 2026-07-19. The official BIDS Validator image ran under the hardened validator (`bids/validator@sha256:8ef7bf2…`); no raw metadata was rewritten, no data was reacquired, no voxel array was loaded. Result: 0 errors, 139 warnings (3 JSON_KEY_RECOMMENDED, 135 SIDECAR_KEY_RECOMMENDED, 1 README_FILE_MISSING), 0 ignored. All 22 files are mode 600; all 16 private dirs mode 700; hashes, sizes, and mtimes unchanged from acquisition. Evidence: `ds000030-pilot-raw-validation-sha256:41c31c09f0fbacc0425f2847333d5e20fd70edec4811a2a251cf5c134c5822ec`. Preprocessing has not begun. ABIDE and COBRE remain blocked; expansion unauthorized.
