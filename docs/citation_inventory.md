...
| --- | --- | --- | --- | --- | --- | --- |
| ABIDE-I | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Unverified | Not verified | Main large-N multiverse cohort for RQ1-RQ4 |
| Preprocessed Connectomes Project ABIDE derivatives | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Unverified | Not verified | Source of the CCS, C-PAC, DPARSF, and NIAK derivative pipelines and their quality-control flags |
| OpenNeuro ds000030 | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Unverified | Not verified | Controlled raw inputs for the pipeline-agreement analysis (RQ5) |
| COBRE | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Unverified | Not verified | Independent schizophrenia replication cohort |
| NIAK COBRE derivative release | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. | Unverified | Not verified | Lightweight derivative used for the replication analysis |
