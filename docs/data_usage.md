...
| Verified license / data-use status | Creative Commons Attribution-NonCommercial-Share Alike (CC BY-NC-SA 3.0); non-commercial, share-alike, re-identification prohibited. Verified 2026-07-17. | CC0 (public-domain dedication) per snapshot 1.0.0 metadata. Verified 2026-07-17. | CC BY 4.0 per figshare article metadata. Verified 2026-07-17. | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. |
...
| Expected acquisition size | Computed from the FCP-INDI S3 object listing at acquisition; phenotypic file Phenotypic_V1_0b_preprocessed1.csv verified at 449,443 bytes. | Full snapshot 85,127,263,296 bytes (provider-reported, OpenNeuro GraphQL); the 20-subject pilot subset is computed from per-file snapshot metadata. | 657,308,547 bytes across 297 files (figshare API article 4197885). | Authoritative verification required before acquisition. | Authoritative verification required before acquisition. |
| Verification date | 2026-07-17 | 2026-07-17 | 2026-07-17 | Not verified | Not verified |
| Verification status | Source, license, and citation verified; access authorization pending manual user registration (NITRC + INDI) | Source, license, and citation verified; access READY | Source, license, and citation verified; access READY | Unverified (optional, not acquired) | Unverified (optional, not acquired) |
...
| License verified | Yes (CC BY-NC-SA 3.0) | Yes (CC0) | Yes (CC BY 4.0) |
| Citation verified | Yes | Yes | Yes |
| Access authorization verified | No — manual NITRC + INDI registration required | Yes (public, no auth) | Yes (public, no auth) |
...
| Ready for acquisition | No | No — awaiting governance-gate approval | No — awaiting governance-gate approval |
